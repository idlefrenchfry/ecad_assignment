...
while ($row = $result->fetch_array()) 
{
    ...
    if ($onOffer == 1)
    {
        ...
        $MainContent .= "<p class='card-text' style='font-size: 1.3em; color:red; font-weight:bold;'>S$ $formattedPrice</p>";
        $MainContent .="<p style='color:red; font-weight:bold;'>On Offer</p>";
